...
const RouteWithLoader = ({ component: Component, ...rest }) => {
  ...
  return (
    <Route {...rest} render={props => login && rest.path === Routes.Signin.path ? <Redirect to={Routes.DashboardOverview.path} /> : ( <> <Preloader show={loaded ? false : true} /> <Component {...props} /> </> )} />
  );
};
